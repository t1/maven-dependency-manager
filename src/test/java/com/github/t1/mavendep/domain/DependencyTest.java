...
class DependencyTest {
    ...
    void shouldBeValid_whenAllFieldsArePresent() {
        var dependency = new Dependency("com.example", "lib", Version.fromString("1.0.0"), Scope.compile);
    ...
    void shouldBeInvalid_whenGroupIdIsNull() {
        var dependency = new Dependency(null, "lib", Version.fromString("1.0.0"), Scope.compile);
    ...
    void shouldBeInvalid_whenArtifactIdIsNull() {
        var dependency = new Dependency("com.example", null, Version.fromString("1.0.0"), Scope.compile);
    ...
    void shouldBeInvalid_whenVersionIsNull() {
        var dependency = new Dependency("com.example", "lib", null, Scope.compile);
    ...
    void shouldNotBeManaged_whenGroupIdIsNull() {
        var dependency = new Dependency(null, "lib", null, Scope.compile);
    ...
    void shouldNotBeManaged_whenArtifactIdIsNull() {
        var dependency = new Dependency("com.example", null, null, Scope.compile);
    ...
    void shouldFormatToString_whenAllFieldsArePresent() {
        var dependency = new Dependency("com.example", "lib", Version.fromString("1.0.0"), Scope.test);
    ...
    void shouldFormatToStringWithoutScope_whenScopeIsDefault() {
        var dependency = new Dependency("com.example", "lib", Version.fromString("1.0.0"), Scope.DEFAULT);
    ...
    void shouldFormatToStringWithVersionAndScope_whenBothArePresent() {
        var dependency = new Dependency("com.example", "lib", Version.fromString("2.5.1"), Scope.provided);
    ...
    void shouldCreateUpdate_whenCalled() {
        var dep = new Dependency("com.example", "lib", Version.fromString("1.0.0"), Scope.compile);
    ...
    void shouldCreateUpdateWithTestScope_whenScopeIsTest() {
        var dep = new Dependency("org.junit", "junit", Version.fromString("4.12"), Scope.test);
